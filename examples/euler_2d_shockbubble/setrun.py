...
#------------------------------
    ...
    probdata.add_param('x0',        0.5,  'x0 - x-coord. center of bubble')
    probdata.add_param('y0',        0.0,  'y0 - y-coord. center of bubble')
    probdata.add_param('r0',        0.2,  'r0 - radius of bubble')
    ...
    clawdata.upper[1] = 0.5000000e+00          # yupper

    # Number of grid cells:
    clawdata.num_cells[0] = 64      # mx
    clawdata.num_cells[1] = 16      # my
    ...
    #   4 or 'mc'       ==> MC limiter
    clawdata.limiter = ['mc', 'mc', 'mc', 'mc', 'minmod']
